...
/* $Id: averun.c,v 1.6 1999/07/16 01:48:11 edwardc Exp $ */
...
int     draw_pic()
{
        ...
        time(&now);
        fprintf(fp, "[1;37m  0 [36m©»      [37m´óºì»¨µÄ¹ú¶ÈÆ½¾ù¸ºÔØÈËÊýÍ³¼Æ[36m    ");
        ...
        fprintf(fp, "                         [1;36m    1 [32m  [36m = [37m%3d     [36m Æ½¾ùÉÏÕ¾ÈËÊý£º[37m%3d[m\n",item,aver);
        fclose(fp);
}

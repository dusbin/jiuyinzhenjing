...
{
    //register int __res __asm__("%eax");
    int __res;
    __asm__("cld\n"
            "1:\tdecl %3\n\t"
            "js 2f\n\t"
...
unsigned strspn(const char *cs, const char *ct)
{
...
unsigned strcspn(const char *cs, const char *ct)
{
    //register char * __res __asm__("%esi");
    char * __res;
    __asm__("cld\n\t"
...
{
    register int __res __asm__("%ecx");
    __asm__("cld\n\t"
        "repne\n\t" 
        "scasb\n\t" 
        "notl %0\n\t" 
...
void * memchr(const void *cs, char c, unsigned count)
{
...
void * memset(void *s, char c, unsigned count)
{
    __asm__ __volatile__ ("cld\n\t"
        "rep\n\t" 
        "stosb" 

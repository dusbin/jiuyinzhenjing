...
*/
/*
$Id: bbs.h,v 1.17 1999/07/31 12:33:20 edwardc Exp $
*/
...
//#include "../util/upgrade/include/struct.M2.h"
...
struct commands cmdlist[] ; /* main menu command list */
struct commands xyzlist[] ;   /* These are command lists for all the */
struct commands talklist[] ;  /* sub-menus */
struct commands maillist[] ;
struct commands dellist[] ;
